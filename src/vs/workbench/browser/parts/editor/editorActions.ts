	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.CommandCenter, order: 103, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled') }
			]
		});
	}
	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.CommandCenter, order: 102, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled') }
			]
		});
	}
