...
import odooPullInfo from './media/odoo_pull_info.js';
...
gettingStartedContentRegistry.registerProvider('vs/workbench/contrib/welcomeGettingStarted/common/media/odoo_pull_info', odooPullInfo);
